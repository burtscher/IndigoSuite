...
os.system('clang -fopenmp -O3 -g -Iinclude -fsanitize=thread OpenMP/conditional_vertex_neighbor/conditional_vertex_neighbor.c -o microbenchmark')
...
print('undirect_power_law_200n_400e.egr')
os.system('clang -fopenmp -O3 -Iinclude -fsanitize=thread OpenMP/conditional_vertex_neighbor/conditional_vertex_neighbor_atomicBug.c -o microbenchmark')
os.system('TSAN_OPTIONS="suppressions=tsan_suppress.txt" ./microbenchmark inputs/power_law/undirect_power_law_200n_400e.egr %s' % args[1])
os.system('TSAN_OPTIONS="suppressions=tsan_suppress.txt" ./microbenchmark inputs/power_law/undirect_power_law_200n_400e.egr %s' % args[1])
os.system('TSAN_OPTIONS="suppressions=tsan_suppress.txt" ./microbenchmark inputs/power_law/undirect_power_law_200n_400e.egr %s' % args[1])
...
os.system('clang -fopenmp -O3 -Iinclude -fsanitize=thread OpenMP/conditional_vertex_neighbor/conditional_vertex_neighbor_boundsBug.c -o microbenchmark')
